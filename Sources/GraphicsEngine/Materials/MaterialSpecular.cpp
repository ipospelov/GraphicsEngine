...
void MaterialSpecular::Init(Object * pObject)
{
...
void MaterialSpecular::Deinit()
{
    Material::Deinit();
}

void MaterialSpecular::SetMaterial()
{
    ...
    SetMaterialBegin();
    {
        ...
        SetPixelShaderBegin();
        SetPixelShaderMatrix4x4("matViewInversed", viewModel);
